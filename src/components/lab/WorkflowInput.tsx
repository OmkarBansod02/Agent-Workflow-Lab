...
export function WorkflowInput({
  ...
  return (
    <div className="rounded-xl border border-white/[0.08] bg-[#1B1A18] p-5 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <Badge className="text-[11px] font-mono bg-[#262320] text-[#78716C] border border-white/[0.08] hover:bg-[#262320]">
          Seeded runner
        </Badge>
      </div>
      <Textarea
        className="min-h-[96px] resize-none text-sm leading-relaxed border-white/[0.06] bg-[#131210] text-stone-100 placeholder:text-[#78716C] focus-visible:ring-[#FF5A2A]/30 focus-visible:border-[#FF5A2A]/40"
        value={request}
      ...
      <div className="grid grid-cols-2 gap-2">
        <Button
          ...
          className="text-[13px] border-[#FF5A2A]/30 text-[#FF6A3D] hover:bg-[#FF5A2A]/12 hover:text-[#FF7048]"
        >
        ...
        <Button
          ...
          className="text-[13px] bg-[#FF5A2A] hover:bg-[#FF7048] text-white accent-glow"
        >
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {runMode === "compiled-workflow" && (
          <Badge variant="outline" className="text-[11px] shrink-0 border-[#FF5A2A]/30 text-[#FF6A3D] bg-[#FF5A2A]/12">
            Compiled AI plan
          </Badge>
        )}
        {runMode === "request-only" && (
          <Badge variant="outline" className="text-[11px] shrink-0 border-white/[0.08] text-[#A8A29E]">
            Request-only
          </Badge>
        )}
      </div>

      <p className="rounded-lg border border-white/[0.06] bg-[#201F1D] px-3 py-2 text-xs leading-relaxed text-[#A8A29E]">
